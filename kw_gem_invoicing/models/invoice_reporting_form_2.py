...
class AccountInvoiceSaleReport2(models.Model):
    ...
    def _select_sale(self, fields_=None):
        ...
        select_ = """SELECT
            ...
            s.kw_clinical_diagnosis as clinical_diagnosis_id,
...
class AccountInvoiceReport(models.Model):
    ...
    def _where(self):
        return '''
            WHERE l.display_type IS NULL and l.product_id IS NOT NULL and
            s.id = payroll.sale_order_id and l.kw_product_qty != 0
            '''
